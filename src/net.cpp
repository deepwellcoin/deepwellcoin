...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("DeepWellCoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("DeepWellCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DeepWellCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("DeepWellCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("DeepWellCoin-adrdump");
...
{
    // Make this thread recognisable as the connection opening thread
    RenameThread("DeepWellCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("DeepWellCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DeepWellCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("DeepWellCoin-start");
