/* src/config/deepwellcoin-config.h.  Generated from deepwellcoin-config.h.in by configure.  */
/* src/config/deepwellcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef DEEPWELLCOIN_CONFIG_H

#define DEEPWELLCOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/deepwellcoin/deepwellcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "DeepWellCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "DeepWellCoin Core 1.4.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "deepwellcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "http://deepwellcoin.org/"
