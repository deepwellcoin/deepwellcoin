// Copyright (c) 2014 The DeepWellCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("DeepWellCoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("DeepWellCoin-smsg-pow"); // Make this thread recognisable
