...
public:
    ...
    {
        // DeepWellCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // DeepWellCoin: get transaction coin age
...
public:
    ...
    // DeepWellCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // DeepWellCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // DeepWellCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // DeepWellCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // DeepWellCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // DeepWellCoin: block index flags
    enum  
    {
