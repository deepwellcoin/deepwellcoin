...
namespace Checkpoints
{
    ...
    // DeepWellCoin: synchronized checkpoint (centrally broadcasted)
    ...
    // DeepWellCoin: get last synchronized checkpoint
    ...
    // DeepWellCoin: only descendant of current sync-checkpoint is allowed
    ...
    // DeepWellCoin: reset synchronized checkpoint to last hardened checkpoint
...
// DeepWellCoin: sync-checkpoint master key
...
// DeepWellCoin: verify signature of sync-checkpoint message
...
// DeepWellCoin: process synchronized checkpoint
