/* src/deepwellcoin-config.h.  Generated from deepwellcoin-config.h.in by configure.  */
/* src/deepwellcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "deepwellcoin@gmail.org"
