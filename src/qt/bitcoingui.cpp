...
#ifdef Q_OS_MAC
    resize(960, 610);
    setWindowTitle(tr("DeepWellCoin wallet - Mac"));
#elif _WIN32
    resize(890, 600);
    setWindowTitle(tr("DeepWellCoin wallet - Windows"));
#else
    resize(1020, 650);
    setWindowTitle(tr("DeepWellCoin wallet - Linux"));
#endif
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a DeepWellCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About DeepWellCoin"), this);
    aboutAction->setToolTip(tr("Show information about DeepWellCoin"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for DeepWellCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("DeepWellCoin client") + QString(" ") + tr("[testnet]")); 
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("DeepWellCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DeepWellCoin network", "", count));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid DeepWellCoin address or malformed URI parameters."));
    }
